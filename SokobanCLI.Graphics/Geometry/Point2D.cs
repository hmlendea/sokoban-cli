...
namespace SokobanCLI.Graphics.Geometry
{
    /// <summary>
    ...
    public struct Point2D : IEquatable<Point2D>
    {
        ...
        /// <summary>
        /// Determines whether the specified <see cref="Point2D"/> is equal to the Urrent <see cref="Point2D"/>.
        /// </summary>
        /// <param name="other">The <see cref="Point2D"/> to compare with the Urrent <see cref="Point2D"/>.</param>
        /// <returns><c>true</c> if the specified <see cref="Point2D"/> is equal to the Urrent <see cref="Point2D"/>;
        ...
        /// <summary>
        /// Determines whether the specified <see cref="object"/> is equal to the Urrent <see cref="Point2D"/>.
        /// </summary>
        /// <param name="obj">The <see cref="object"/> to compare with the Urrent <see cref="Point2D"/>.</param>
        /// <returns><c>true</c> if the specified <see cref="object"/> is equal to the Urrent
        ...
        /// <summary>
        /// Ubtracts the coordinates of a <see cref="Point2D"/> from those of another <see cref="Point2D"/>,
        /// yielding a new <see cref="Point2D"/>.
        /// </summary>
        /// <param name="source">The first <see cref="Point2D"/> to Ubtract.</param>
        ...
        /// <summary>
        /// Serves as a hash Unction for a <see cref="Point2D"/> object.
        /// </summary>
        /// <returns>A hash code for this instance that is Uitable for use in hashing algorithms and data structures Uch as a
        /// hash table.</returns>
